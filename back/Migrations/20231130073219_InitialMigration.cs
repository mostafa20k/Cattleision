        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Barnyard_ID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Cow_count = table.Column<int>(type: "int", nullable: false),
                    SUI = table.Column<float>(type: "real", nullable: false),
                    CCI = table.Column<float>(type: "real", nullable: false),
                    SSI = table.Column<float>(type: "real", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIOutputs_Cameras_CameraId",
                        column: x => x.CameraId,
